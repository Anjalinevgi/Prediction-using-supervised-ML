...
#From the scatter plot and the correlation coeffiecient(0.96), we can assume that both variables are positively,linearly related
...
cat('The predicted percentage score of a student that studies for 9.5 hours a day is',pred)
